#Import the Data
getwd()
setwd("/Volumes/M1 SSD/R prac/R Programming A-Z-Basics/Section 6 Advanced Visualization/Homework")
...
#also we can do filt2 <- mov$Studio %in% c("Buena Vista Studios",....)
